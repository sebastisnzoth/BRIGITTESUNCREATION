...
## P3 — Audiência e marketing orgânico
- [ ] Manifesto e press kit.
- [ ] SEO Brasil + internacional.
- [ ] Estratégia de redes sociais.
- [ ] Scout de nichos e oportunidades.
- [ ] Relações com imprensa, festivais, livrarias e comunidades.

## P4 — Internacionalização
- [ ] PT-BR como origem.
- [ ] Materiais institucionais ES/EN.
- [ ] Pipeline de tradução da obra com aprovação humana obrigatória.
- [ ] Mapa de mercados escolhido por Brigitte com suporte do Scout.

## P5 — Transmedia
- [ ] Música.
- [ ] Cinema/audiovisual.
- [ ] Teatro e outras manifestações culturais.
- [ ] Produtos da marca quando houver validação jurídica e operacional.

## Métrica principal
Construir alcance e receita sem sacrificar autoria, controle, identidade ou sustentabilidade financeira.
